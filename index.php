...
<body>
    <div id="header">
        <img src="Image/btec.png" alt="BTEC logo" height="180">
        <marquee behavior="" direction="left" scrolldelay="120"><b>^^ Welcome to our store ^^</b></marquee>
    </div>
    ...
    <div id="footer">
        <p><b>BTEC Cần Thơ</b> &#169; TextPlan by LongNHG 2023<br></p>
        <i>Address:</i> 41 Cách Mạng Tháng Tám, P.An Hòa, Q.Ninh Kiều, TP.Cần Thơ <br>
        <i>Phone:</i> +84 908541764
    </div>
